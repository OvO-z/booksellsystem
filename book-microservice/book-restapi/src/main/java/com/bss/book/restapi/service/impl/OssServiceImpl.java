...
import com.bss.book.domain.dto.OssCallbackParam;
...
public class OssServiceImpl implements OssService {
    ...
    @Override
    public OssFileParam delete(OssFileParam param) {
        ossClient.deleteObject(ALIYUN_OSS_BUCKET_NAME,param.getName());
        return param;
    }
}
